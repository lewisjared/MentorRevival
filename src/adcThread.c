...
static const ADCConversionGroup adcgrpcfg =
{
  ...
  0,						/*HTR*/
  {							/*smpr[2]*/
		  ADC_SMPR1_SMP_AN10(SAMPLE_RATE) | ADC_SMPR1_SMP_AN11(SAMPLE_RATE) |
		  ADC_SMPR1_SMP_AN12(SAMPLE_RATE),
		  ADC_SMPR2_SMP_AN5(SAMPLE_RATE) | ADC_SMPR2_SMP_AN6(SAMPLE_RATE) |
		  ADC_SMPR2_SMP_AN7(SAMPLE_RATE),
  },
  { /*sqr[3]*/
		  ADC_SQR1_NUM_CH(ADC_NUM_CHANNELS), //SQR1
		  0, // SQR2
		  ADC_SQR3_SQ1_N(ADC_CHANNEL_IN10) | ADC_SQR3_SQ2_N(ADC_CHANNEL_IN11) |
		  ADC_SQR3_SQ3_N(ADC_CHANNEL_IN12) | ADC_SQR3_SQ4_N(ADC_CHANNEL_IN5) |
		  ADC_SQR3_SQ5_N(ADC_CHANNEL_IN6) | ADC_SQR3_SQ6_N(ADC_CHANNEL_IN7)
  }
 };
